...
% We will make a distinction between commanded rudder angle and actual rudder angle. In theory, we assume that any arbitrary
...
% Express the equations of motion in the state space form.
