...
% transverse motion while the carriage is moving forward with speed v.
...
% Try running the code that corresponds to pure sway and see what you observe from the plots.
