...
//***** PROPERTIES *****//
//Sections
SparB = PipeSection(9.4 m, 0.01 m);
SparT = PipeSection(6.5 m, 0.01 m);
...
Steel.setDefault();
SparT.setDefault();
SparTOP = Beam(Point(0 m,0 m,10 m), Point(0 m,0 m,-4 m));
SparTOP.CurveOffset = ReparameterizedBeamCurveOffset(NoCurveOffset());
SparB.setDefault();
SparBTM = Beam(Point(0 m,0 m,-12 m), Point(0 m,0 m,-120 m));
SparBTM.CurveOffset = ReparameterizedBeamCurveOffset(NoCurveOffset());
...
SparTop = GuidePlane(Point(-10 m,-10 m,-4 m), Point(10 m,-10 m,-4 m), Point(10 m,10 m,-4 m), Point(-10 m,10 m,-4 m), 2, 2, 1, 1, 1, 1);
Top = GuidePlane(Point(-10 m,-10 m,-12 m), Point(10 m,-10 m,-12 m), Point(10 m,10 m,-12 m), Point(-10 m,10 m,-12 m), 2, 2, 1, 1, 1, 1);
